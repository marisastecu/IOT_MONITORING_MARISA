...
function updateRelayUI() {
  for (let i = 0; i < 4; i++) {
    ...
    if (!card) continue;
    if (relayState[i]) {
      card.classList.add('on'); card.classList.remove('disabled');
    } else {
